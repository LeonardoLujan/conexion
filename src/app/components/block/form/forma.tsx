        ...
        <div className="">
            <form className="max-w-sm bg-white rounded-full bg-slate-100">
                <div className="flex justify-center p-3">
                    <input className="appearance-none bg-transparent border-none text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Como te puedo ayudar?" aria-label="Full name"/>
                        <Link href="./help">
